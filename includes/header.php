    ...
    <ul class="nav navbar-nav navbar-collapse collapse nav_links">
      ...
      <li><div class="dropdown">
        ...
        <div class="dropdown-content dropdownnav">
          ...
          <a href="ach/login_query.php">Check Status <span>جانچ</span> </a>
        </div>
      </div>
      </li>
       <li><div class="dropdown">
        ...
        <div class="dropdown-content dropdownnav">
          <a href="index.php?action=complaint" >New Complaint <span>نیا شکایت</span> </a>
          <a href="ach/login.php">Check Status <span>جانچ</span> </a>
        </div>
      </div>
      </li>
