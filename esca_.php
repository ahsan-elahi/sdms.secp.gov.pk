...
$sql = "SELECT * FROM `sdms_ticket` WHERE `isaccepted`=0 AND TIMESTAMPDIFF(DAY,created,NOW())>=3 AND TIMESTAMPDIFF(DAY,created,NOW())<=14 AND isrejected<>'1' AND isquery='0' AND ticket_id>=4100 AND status='open'"; 
