...
$include_image = isset($_REQUEST['include_image']) ? TRUE : FALSE;
	...
	$_REQUEST['date']="2017-10-10";
	$_REQUEST['notifi_title']="Test shahzaib shahzaib Title";
	$_REQUEST['notifi_descp']="TEST ahsan ahsan Description";
...
$push->setMessage_long($notifi_descp);
