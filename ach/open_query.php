...
{
$inc='open_urdu_query.inc.php';    //default include.
}else{
$inc='open_query.inc.php';    //default include.
}
...
/*if(!$errors && $cfg->allowOnlineAttachments() && $_FILES['attachments'])
    ...
    if($vars['assignId']!=0 && ($ticket = Ticket::create($vars, $errors, SOURCE))){
		...
		$vars['note'] = 'Query Lodge from WebSite';
        ...
        //Thank the user and promise speedy resolution!
		    ...
		    if($_POST['lang']=='urdu')
	{
	    $inc='thankyou_query_urdu.inc.php';
	}else{
	    $inc='thankyou_query.inc.php';
	}
    }else{
