...
if($ost->isUpgradePending()) {
    ...
    if(!strcasecmp(basename(CONFIG_FILE), 'settings.php')) {
        $sysnotice=sprintf('Please rename config file include/%s to include/sdms-config.php to avoid possible conflicts',
...
//Page title.
$ost->setPageTitle('SECP GRS :: Staff Control Panel');
?>
