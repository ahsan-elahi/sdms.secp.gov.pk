...
class StaffNav {
    ...
    function getTabs(){
        ...
        if(!$this->tabs) {
            ...
            $this->tabs['tickets']=array('desc'=>'Complaint','href'=>'tickets.php','title'=>'Ticket Queue');
...
class AdminNav extends StaffNav{
    ...
    function getTabs(){
        ...
        if(!$this->tabs){
			...
			$tabs['reports']=array('desc'=>'Reports','href'=>'report.php','title'=>'Reports');//////////mine code
            $this->tabs=$tabs;
        }
        ...
        foreach($this->getTabs() as $k=>$tab){
            ...
            switch(strtolower($k)){
                ...
                case 'staff':
                    ...
                    break;
             case 'reports':                                          //////////////////////////////mine code
                    $subnav[]=array('desc'=>'Reports','href'=>'report.php','iconclass'=>'users');
                    $subnav[]=array('desc'=>'Complaint&nbsp;Summery','href'=>'complaintsummary.php','iconclass'=>'teams');
                    $subnav[]=array('desc'=>'Complaint&nbsp;Source','href'=>'complaintsource.php','iconclass'=>'groups');
					$subnav[]=array('desc'=>'Area&nbsp;Report','href'=>'aera.php','iconclass'=>'groups');
                    $subnav[]=array('desc'=>'Complaint&nbsp;Views','href'=>'complaintview.php','iconclass'=>'departments');
                    break;
