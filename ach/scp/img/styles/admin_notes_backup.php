...
*/
  ...
  //include(DIR_WS_LANGUAGES.$language.'/'. FILENAME_ADMIN_NOTES);
...
?>
            <td align="right"><table border="0" width="100%" cellspacing="0" cellpadding="0">
              ...
              <tr><?php echo tep_draw_form('search_type', FILENAME_ADMIN_NOTES, '', 'get'); ?>
                <td class="smallText" align="right"><?php echo TEXT_SELECT_CATEGORY . ' ' . tep_draw_pull_down_menu('file_type_id', $file_type_array, $file_type_search['category'], 'onChange="this.form.submit();"') . tep_hide_session_id(); ?></td>
              </form></tr>
            </table></td>
<?php
}
