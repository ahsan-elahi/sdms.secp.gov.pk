...
if(!@$thisstaff->isStaff() || !$query->checkStaffAccess($thisstaff)) die('Access Denied');
...
<?php if($msg=='Query created successfully' && $query->getSource()=='Through Call'){?>
...
<div class="span12" style="float:right;">
	<div class="span10">
        ...
        <?php /*?><a id="popup_print" >
        <button class="btn" type="button" ><i class="icon-print"></i> Print</button></a><?php */?>    
...
<div class="span9">
<select name="status_pid" style="width:300px;" onChange="get_Sub_Status(this.value)">
...
<div class="span3">Query Status:</div>
<div class="span9">
<select name="status_pid" style="width:300px;" onChange="get_Sub_Status_note(this.value)">
<option value="">--Select Status--</option>
<?php
$sql_get_child_status='SELECT *  FROM sdms_status status WHERE status_id = '.$query->complaint_status_title().' ';
$res_get_child_status=db_query($sql_get_child_status);
