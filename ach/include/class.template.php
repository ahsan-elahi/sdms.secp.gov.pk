...
class Template {
    ...
    function message_templates(){
        ...
        $messages=array('ticket_autoresp'=>array('name'=>'New Complaint Auto-response',
                                                 'desc'=>'Autoresponse sent to user, if enabled, on new ticket.'),
                        'ticket_autoreply'=>array('name'=>'New Complaint Auto-reply',
                                                 'desc'=>'Canned Auto-reply sent to user on new Complaint, based on filter matches. Overwrites "normal" auto-response.'),
                        'msg_autoresp'=>array('name'=>'New Message Auto-response',
                                              'desc'=>'Confirmation sent to user when a new message is appended to an existing Complaint.'),
                        'ticket_notice'=>array('name'=>'New Complaint Notice',
                                               'desc'=>'Notice sent to user, if enabled, on new Complaint created by staff on their behalf (e.g phone calls).'),
                        'overlimit_notice'=>array('name'=>'Over Limit Notice',
                                                  'desc'=>'A one time notice sent, if enabled, when user has reached the maximum allowed open Complaints.'),
                        'ticket_reply'=>array('name'=>'Response/Reply Template',
                                              'desc'=>'Template used on Complaint response/reply'),
                        'ticket_alert'=>array('name'=>'New Complaint Alert',
                                              'desc'=>'Alert sent to staff, if enabled, on new Complaint.'),
                        'msg_alert'=>array('name'=>'New Message Alert',
                                           'desc'=>'Alert sent to staff, if enabled, when user replies to an existing Complaint.'),
                        'note_alert'=>array('name'=>'Internal Note Alert',
                                            'desc'=>'Alert sent to selected staff, if enabled, on new internal note.'),
                        'assigned_alert'=>array('name'=>'Complaint Assignment Alert',
                                                'desc'=>'Alert sent to staff on Complaint assignment.'),
                        'transfer_alert'=>array('name'=>'Complaint Transfer Alert',
                                                'desc'=>'Alert sent to staff on Complaint transfer.'),
                        'overdue_alert'=>array('name'=>'Overdue Complaint Alert',
                                               'desc'=>'Alert sent to staff on stale or overdue Complaints.')
                        );
        return $messages;
    }
