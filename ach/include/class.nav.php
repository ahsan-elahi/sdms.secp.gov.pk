    ...
    function getSubMenus(){ //Private.ssss
        ...
        foreach($this->getTabs() as $k=>$tab){
            ...
            switch(strtolower($k)){
				...
				elseif($stats && $staff->getGroupId() == 8)
				{
				$subnav[] = array('desc'=>'Accepted ('.$staff->getNumAssignedTickets().')','title'=>'Accepted ','href'=>'tickets.php','iconclass'=>'Ticket','class'=>'ibw-Open_Complaints');
				}
				//	}
				if($stats['overdue']) {
				$subnav[] =  array('desc'=>'Overdue ('.number_format($stats['overdue']).')','title'=>'Stale Complaints','href'=>'tickets.php?status=overdue','iconclass'=>'overdueTickets','class'=>'ibw-Stale_Complaints');
				}
				if($staff->showAssignedOnly() && $stats['closed']) {
				$subnav[] =  array('desc'=>'My Closed Complaints ('.number_format($stats['closed']).')','title'=>'My Closed Complaints','href'=>'tickets.php?status=closed','iconclass'=>'closedTickets','class'=>'ibw-Closed_Complaints');
				} 
				else {
				...
				$subnav[] =  array('desc'=>'Nearing Overdue','title'=>'Nearing Overdue Complaints','href'=>'tickets.php?status=nearoverdue','iconclass'=>'overdueTickets','class'=>'ibw-Stale_Complaints');
				$subnav[] =  array('desc'=>'Reopen Complaints','title'=>'Reopen Complaints','href'=>'tickets.php?action=reopen','iconclass'=>'overdueTickets','class'=>'ibw-Stale_Complaints');
				$subnav[] =  array('desc'=>'Reply to User ('.number_format($stats['rplytouser']).')','title'=>'Reply to User','href'=>'tickets.php?action=replytouser','iconclass'=>'overdueTickets','class'=>'ibw-Stale_Complaints');	
				$subnav[] =  array('desc'=>'SDA Activity','title'=>'SDA Activity','href'=>'tickets.php?action=updatebyagent','iconclass'=>'overdueTickets','class'=>'ibw-Stale_Complaints');	
				...
				if($staff->getDeptId() == 6)
				{
	$subnav[]=array('desc'=>'Sub Departments','title'=>'Sub Departments','href'=>'tickets.php?action=subdept','iconclass'=>'Ticket','class'=>'ibw-all-complaints');
				}
				break;	
				...
				$subnav[] =  array('desc'=>'Reply to User ('.number_format($stats_query['rplytouser']).')','title'=>'Reply to User','href'=>'queries.php?action=replytouser','iconclass'=>'overdueTickets','class'=>'ibw-Stale_Complaints');	

				$subnav[] =  array('desc'=>'SDA Activity','title'=>'SDA Activity','href'=>'queries.php?action=updatebyagent','iconclass'=>'overdueTickets','class'=>'ibw-Stale_Complaints');
				}
				
				if($staff->getDeptId() == 6)
				{
	$subnav[]=array('desc'=>'Sub Departments','title'=>'Sub Departments','href'=>'queries.php?action=subdept','iconclass'=>'Ticket','class'=>'ibw-all-complaints');
				}	
				break;
...
$subnav[]=array('desc'=>'Average Resolution','href'=>'query_average_resolution.php','iconclass'=>'departments','title'=>'SDMS','class'=>'ibw-geog_r');
	  break; 
...
$subnav[]=array('desc'=>'Status Ageing detail','href'=>'comlaintstatus_new_v1.php','iconclass'=>'departments','title'=>'Complaints Status','class'=>'ibw-r_new');
/*$subnav[]=array('desc'=>'Nature of complaints OLD','href'=>'comlaintscategory_new.php','iconclass'=>'departments','title'=>'Complaints Categories','class'=>'ibw-r_new');
*/
$subnav[]=array('desc'=>'Nature of complaints','href'=>'nature_of_complaints_sub_status.php','iconclass'=>'departments','title'=>'Complaints Categories','class'=>'ibw-r_new');
