...
<div class="container-fluid">
	<div class="container" style="background-color: white;">
		...
		<div class="col-lg-12 col-xs-12 text-center nav_links" style="color: #a2a2a2;">
          ...
          <p style="color: red;
    font-size: 16px;
    text-align: center;" >“Before proceeding, please select between Query OR Complaint from the above menu” </p>
          <p style="color: red;
    font-size: 16px;
    text-align: center;">آگے بڑھنے سے پہلے، اوپر کے مینو سے سوال یا شکایت کے درمیان کا انتخاب کریں</p>
        </div>
