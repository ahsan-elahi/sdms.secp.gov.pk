      ...
      <div id="verification" class="wizard-step">
        <div class="col-lg-8 padding-top-10">
          <div class="form-group">
            ...
            <div class="col-xs-12 text-center" ><!---->
              <input type="text" name="sms_vrify" id="sms_code" required class="form-control" placeholder="Enter Your Code" style="width: 40%; margin: 0 auto;"   >
...
OR send us your concern through postal mail at:<br> <span style="color:#4E9EE3;"> Securities and Exchange Commission of Pakistan<br> NIC Building, 63 Jinnah Avenue, Blue Area, Islamabad <br></span>
</div>
        </div>
        <div class="hidden-xs">
