...
ہمیں آپ کی شکایت  موصول ہو گئی ہے اور اسے متعلقہ شعبے میں بھجوا دیا گیا ہے۔ آپ شکایت نمبر <?php echo  $ticket->number; ?> اور پِن کوڈ <?php echo $ticket->ticketpin;?> کے ذریعے اپنی شکایت کے بارے میں تازہ ترین معلومات حاصل کر سکتے ہیں۔ آپ سے جلد رابطہ کر لیا جائے گا۔
...
<span style="float:right;">ای میل:  complaints@secp.gov.pk</span>
                </p>
				</div>
				<div class="col-xs-12">
