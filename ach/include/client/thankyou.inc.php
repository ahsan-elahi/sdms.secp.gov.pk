...
<div class="container-fluid">
	<div class="container" style="background-color: white">
		<div class="row" style="background:url(assets/images/thankyou.png);min-height: 565px;">
               ...
               Your complaint has reached us and is currently under review. You can track your complaint by the following complaint number <?php echo  $ticket->number; ?> and pincode is <?php echo $ticket->ticketpin;?>.  You should expect an update in this regard shortly.<br>
