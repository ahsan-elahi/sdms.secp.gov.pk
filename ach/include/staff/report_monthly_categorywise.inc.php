...
myWindow=window.open("report_monthly_categorywise_print.php","Print Report","toolbar=yes,width=1500px,height=14031px");
...
<div class="row-fluid" style="min-height:700px;">
   <div class="span12">                    
        <div class="head clearfix">
            ...
            <h1><?php echo 'Monthly Wise Report Listing'."&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;From Jan ".date("Y")." To Dec ".date("Y"); ?></h1>                               
        </div>
