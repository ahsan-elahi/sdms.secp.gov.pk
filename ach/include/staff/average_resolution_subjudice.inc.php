...
<input class="btn" type="submit" name="search" value="Search">
    ...
    <div class="row-fluid">
        <div class="span12">                    
            ...
            <tbody>
            <?php 
$sql_get_dept="SELECT * from  sdms_department WHERE 1  ".$dept_add."";
$res_get_dept = mysql_query($sql_get_dept);
while($row_dept = mysql_fetch_array($res_get_dept)){
?>
            <tr>
			...
			$sql_resolve="SELECT * FROM `sdms_ticket` WHERE status='closed' AND dept_id = '".$row_dept['dept_id']."' AND isquery=0 AND  ticket_id not IN (select ticket_id from sdms_ticket_thread where complaint_status IN (14,18,43,46))";
