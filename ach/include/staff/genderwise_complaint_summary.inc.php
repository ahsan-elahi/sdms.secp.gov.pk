...
myWindow=window.open("genderwise_complaint_summary_print.php","Print Report","toolbar=yes,width=800px,height=14031px");
...
<div class="page-header"><h1>Complaint Summary Gender Wise<small>Report</small></h1></div>
<div class="row-fluid">
...
<div class="row-fluid" style="min-height:700px;">
  ...
  <tr>
    ...
    $sql_isoverdue_male='SELECT * FROM '.TICKET_TABLE.' '.'WHERE '.'isoverdue = "1" AND gender="male" AND status != "closed"';	
    $res_isoverdue_male=db_query($sql_isoverdue_male);
    $row_isoverdue_male=db_num_rows($res_isoverdue_male);
    //isoverdue female complaint
    $sql_isoverdue_female='SELECT * FROM '.TICKET_TABLE.' '.'WHERE '.'isoverdue = "1" AND gender="female" AND status != "closed"';	
    $res_isoverdue_female=db_query($sql_isoverdue_female);
    $row_isoverdue_female=db_num_rows($res_isoverdue_female);
    ?>    
    <td><?php echo $row_isoverdue_male; ?></td>
    <td><?php echo $row_isoverdue_female; ?></td>
     <?php 
  ...
  <tr>
    ...
    <?php 
    //isoverdue female complaint
    $sql_isoverdue_male='SELECT * FROM '.TICKET_TABLE.' '.'WHERE  0 >= TIMESTAMPDIFF(DAY,created,NOW()) '.'AND isoverdue = "1" AND gender="male"  AND status != "closed" ';	
    $res_isoverdue_male=db_query($sql_isoverdue_male);
    $row_isoverdue_male=db_num_rows($res_isoverdue_male);
    //isoverdue female complaint
    $sql_isoverdue_female='SELECT * FROM '.TICKET_TABLE.' '.'WHERE  0 >= TIMESTAMPDIFF(DAY,created,NOW()) '.'AND isoverdue = "1" AND gender="female"  AND status != "closed" ';	
    $res_isoverdue_female=db_query($sql_isoverdue_female);
    $row_isoverdue_female=db_num_rows($res_isoverdue_female);
    ?>  
   <td><?php echo $row_isoverdue_male; ?></td>
  ...
  <tr>
    ...
    <?php 
    //isoverdue female complaint
    $sql_isoverdue_male='SELECT * FROM '.TICKET_TABLE.' '.'WHERE  7 >= TIMESTAMPDIFF(DAY,created,NOW()) '.'AND isoverdue = "1" AND gender="male"  AND status != "closed" ';	
    $res_isoverdue_male=db_query($sql_isoverdue_male);
    $row_isoverdue_male=db_num_rows($res_isoverdue_male);
    //isoverdue female complaint
    $sql_isoverdue_female='SELECT * FROM '.TICKET_TABLE.' '.'WHERE  7 >= TIMESTAMPDIFF(DAY,created,NOW()) '.'AND isoverdue = "1" AND gender="female"   AND status != "closed"';	
    $res_isoverdue_female=db_query($sql_isoverdue_female);
    $row_isoverdue_female=db_num_rows($res_isoverdue_female);
    ?>  
   <td><?php echo $row_isoverdue_male; ?></td>
  ...
  <tr>
    ...
    <?php 
    //isoverdue female complaint
    $sql_isoverdue_male='SELECT * FROM '.TICKET_TABLE.' '.'WHERE  30 >= TIMESTAMPDIFF(DAY,created,NOW()) '.'AND isoverdue = "1" AND gender="male"  AND status != "closed" ';	
    $res_isoverdue_male=db_query($sql_isoverdue_male);
    $row_isoverdue_male=db_num_rows($res_isoverdue_male);
    //isoverdue female complaint
    $sql_isoverdue_female='SELECT * FROM '.TICKET_TABLE.' '.'WHERE  30 >= TIMESTAMPDIFF(DAY,created,NOW()) '.'AND isoverdue = "1" AND gender="female"  AND status != "closed" ';	
    $res_isoverdue_female=db_query($sql_isoverdue_female);
    $row_isoverdue_female=db_num_rows($res_isoverdue_female);
    ?>  
   <td><?php echo $row_isoverdue_male; ?></td>
  ...
  <tr>
    ...
    <?php 
    //isoverdue female complaint
    $sql_isoverdue_male='SELECT * FROM '.TICKET_TABLE.' '.'WHERE  365 >= TIMESTAMPDIFF(DAY,created,NOW()) '.'AND isoverdue = "1" AND gender="male"   AND status != "closed"';	
    $res_isoverdue_male=db_query($sql_isoverdue_male);
    $row_isoverdue_male=db_num_rows($res_isoverdue_male);
    //isoverdue female complaint
    $sql_isoverdue_female='SELECT * FROM '.TICKET_TABLE.' '.'WHERE  365 >= TIMESTAMPDIFF(DAY,created,NOW()) '.'AND isoverdue = "1" AND gender="female"   AND status != "closed"';	
    $res_isoverdue_female=db_query($sql_isoverdue_female);
    $row_isoverdue_female=db_num_rows($res_isoverdue_female);
    ?>  
   <td><?php echo $row_isoverdue_male; ?></td>
