...
/* 
   ...
   User can also see Queries assigned to them regardless of the Complaint's dept.
...
if($status=='lodged')
{
	...
	$table_heading = 'In Process';
	
	$qwhere .=" AND ( ";
$sql_sub_status="SELECT * FROM `sdms_status` WHERE p_id='1'";
...
$qwhere .=" )  AND ticket.status = 'open' ";  

	
	//$qwhere.=" AND (ticket.complaint_status = '6' OR ticket.complaint_status = '7' OR ticket.complaint_status = '8') AND ticket.status = 'open' ";   	
	
	}elseif($status == 'closed'){
	$table_heading = 'Closed';
	
		$qwhere .=" AND ( ";
$sql_sub_status="SELECT * FROM `sdms_status` WHERE p_id='2'";
$res_sub_status=mysql_query($sql_sub_status);
$num_sub_status = mysql_num_rows($res_sub_status);
while($row_sub_status=mysql_fetch_array($res_sub_status)){
$qwhere .=" ticket.complaint_status = '".$row_sub_status['status_id']."' OR";
...
$qwhere = substr( $qwhere, 0, -2 );
$qwhere .=" )  AND ticket.status = 'closed' ";  

	//$qwhere.=" AND (ticket.complaint_status = '9' OR ticket.complaint_status = '10' OR ticket.complaint_status = '11' OR ticket.complaint_status = '12' OR ticket.complaint_status = '13' OR ticket.complaint_status = '39') AND ticket.status = 'closed' ";   	
...
$pageNav->setURL('primary_status_queries.php',$qstr.'&sort='.urlencode($_REQUEST['sort']).'&order='.urlencode($_REQUEST['order']));
...
<form action="primary_status_queries.php" method="get">
...
<?php /*?><div class="span3" style="float:right">
    ...
    <form action="primary_status_queries.php" method="POST" name='tickets' id="status-form">
    ...
    <div class="row-fluid">
        ...
        <div class="span12">                    
            ...
            <div class="head clearfix">
                ...
                <div class="isw-grid"></div><h1><?php echo $table_heading .' Queries'; ?></h1>                               
...
$alret='';
        ...
        <tr id="<?php echo $row['ticket_id']; ?>">
          ...
          <a <?php if($flag) { ?> class="Icon <?php echo $flag; ?>Ticket" title="<?php echo ucfirst($flag); ?> Complaint " <?php } ?> 
                ...
                href="queries.php?id=<?php echo $row['ticket_id']; ?>"><?php echo $subject; ?></a>
          ...
          <td nowrap <?php echo $alret; ?>><?php echo $row['District']; ?></td>
...
<!--                <input class="btn btn-inverse" type="submit" name="close" value="Close" id="close_a" >
    ...
    <!--<div style="display:none;" class="dialog_show" id="confirm-action">
        ...
        <p class="confirm-action" style="display:none;" id="mark_overdue-confirm">
            ...
            Are you sure want to flag the selected Queriesas <font color="red"><b>overdue</b></font>?
        ...
        <p class="confirm-action" style="display:none;" id="delete-confirm">
            ...
            <br><br>Deleted QueriesCANNOT be recovered, including any associated attachments.
    ...
    <form action="primary_status.php" method="get" id="search" name="search">
