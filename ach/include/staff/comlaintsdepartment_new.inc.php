...
?>
            ...
            <?php 
			$sub_status .="['1 to 15', ".$t_1to15days."],['15+', ".$t_16to30days."],['30+', ".$t_31to45days."],['45+', ".$t_45daysplus."],['180+', ".$t_180daysplus."],['365+', ".$t_365daysplus."],['730+', ".$t_730daysplus."],['1095+', ".$t_1095daysplus."]";
$sub_status .="]
},
";
