...
<div class="page-header">   
  <h1>Most Complaints Against <small>AMC/Mutual Funds/Modarabah/Leasing/Investment Banking/REIT</small></h1>
</div>
<div class="row-fluid">
<div class="span12">                    
...
<?php
$company_types = array('Asset Management Company','Investment Finance Company','Modaraba Management Company','Leasing Company','Housing Finance Company','Non-bank micro finance company');
  ...
  <div class="span12">
    ...
    <div class="block-fluid table-sorting clearfix">
        <table cellpadding="0" cellspacing="0" width="100%" class="table">
          ...
          <tbody class="" page="1">
			<?php 		
            $sql_status="SELECT scd_broker_title as compay,count(scd_broker_title) as total ,group_concat( complaint_id ) as complaint_ids, group_concat( scd_broker_title) AS companies FROM `sdms_ticket_scd` WHERE ".$broker_title." AND scd_type = '".$company_type."'   group by `scd_broker_title`  order by total desc limit 10 ";
            ...
            $href_company = 'report_tickets.php?action=scd_company&company_type='.$company_type.'&compay='.$row_status['compay'].'';
            ...
            $href_type = 'report_tickets.php?action=scd_company_subtotal&company_type='.$company_type.'';
...
<?php }?>
<?php
$agent_types = array('modaraba_fund','mutual_fund','pension_fund');
foreach($agent_types as $agent_type){?>
<div class="row-fluid">
  <div class="span12">
    <div class="head clearfix">
      <div class="isw-grid"></div>
      <h1>Most Complaints Against <?php echo str_replace('_', ' ', ucwords($agent_type)); ?></h1>
    </div>
    <div class="block-fluid table-sorting clearfix">
        <table cellpadding="0" cellspacing="0" width="100%" class="table">
          <thead>
            <tr>
              <th rowspan="2"><?php echo str_replace('_', ' ', ucwords($agent_type)); ?> Name </th>
              <th rowspan="2" align="center">No. of Complaints</th>
              <th colspan="4" align="center">Aging-IN DAYS</th>
            </tr>
            <tr>
...
$href_company = 'report_tickets.php?action=scd_agent&agent_type='.$agent_type.'&agent='.$row_status['agent'].'';
$href_company_1to15days = $href_company.'&r_type=1to15days&from_date='.$today_date.'&to_date='.$days_1to15.'';
$href_company_16to30days = $href_company.'&r_type=16to30days&from_date='.$days_1to15.'&to_date='.$days_15plus.'';
$href_company_31to45days = $href_company.'&r_type=31to45days&from_date='.$days_15plus.'&to_date='.$days_30plus.'';
$href_company_45daysplus = $href_company.'&r_type=45daysplus&from_date='.$days_30plus.'';

$href_type = 'report_tickets.php?action=scd_agent_subtotal&agent_type='.$agent_type.'';
$href_type_1to15days =$href_type.'&r_type=1to15days&from_date='.$today_date.'&to_date='.$days_1to15.'';
$href_type_16to30days =$href_type.'&r_type=16to30days&from_date='.$days_1to15.'&to_date='.$days_15plus.'';
$href_type_31to45days =$href_type.'&r_type=31to45days&from_date='.$days_15plus.'&to_date='.$days_30plus.'';
$href_type_45daysplus =$href_type.'&r_type=45daysplus&from_date='.$days_30plus.'';
...
<div class="row-fluid">
  <div class="span12">
    <div class="head clearfix">
      <div class="isw-grid"></div>
      <h1>AMC/Mutual Funds/Modarabah/Leasing/Investment Banking/REIT Most Complaints By Complainant</h1>
    </div>
    <div class="block-fluid table-sorting clearfix">
        <table cellpadding="0" cellspacing="0" width="100%" class="table">
          <thead>
...
$href_company = 'report_tickets.php?action=scd_complainant&email='.$row_status['email'].'';
$href_company_1to15days = $href_company.'&r_type=1to15days&from_date='.$today_date.'&to_date='.$days_1to15.'';
$href_company_16to30days = $href_company.'&r_type=16to30days&from_date='.$days_1to15.'&to_date='.$days_15plus.'';
$href_company_31to45days = $href_company.'&r_type=31to45days&from_date='.$days_15plus.'&to_date='.$days_30plus.'';
$href_company_45daysplus = $href_company.'&r_type=45daysplus&from_date='.$days_30plus.'';

$href_type = 'report_tickets.php?action=scd_complainant_subtotal';
$href_type_1to15days =$href_type.'&r_type=1to15days&from_date='.$today_date.'&to_date='.$days_1to15.'';
$href_type_16to30days =$href_type.'&r_type=16to30days&from_date='.$days_1to15.'&to_date='.$days_15plus.'';
$href_type_31to45days =$href_type.'&r_type=31to45days&from_date='.$days_15plus.'&to_date='.$days_30plus.'';
$href_type_45daysplus =$href_type.'&r_type=45daysplus&from_date='.$days_30plus.'';
