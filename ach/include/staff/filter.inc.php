...
<div class="page-header"><h1>Complaint Filter<small>Topic </small></h1></div>  
...
<div class="row-fluid"> <!--main Div start-->
...
<div class="block-fluid ucard">
            <div class="info">                                                                
                ...
                <!--header start-->
                    <li class="heading"><div class="isw-users"></div>Filter Actions:<em>Can be overwriten by other filters depending on processing order.&nbsp;</em></li>
                <!-- header end-->
                    
                    <li>
                        <div class="title">Reject Complaint:</div>
                        <div class="text"><input type="checkbox" name="reject_ticket" value="1" <?php echo $info['reject_ticket']?'checked="checked"':''; ?> >
                    <strong><font class="error">Reject Complaint</font></strong> <em>(All other actions and filters are ignored)</em>
                    </div>
                    </li> 
                    <li>
                        <div class="title">Reply-To Email:</div>
                        <div class="text"><input type="checkbox" name="use_replyto_email" value="1" <?php echo $info['use_replyto_email']?'checked="checked"':''; ?> >
                    <strong>Use</strong> Reply-To Email <em>(if available)</em>
                     </div>
                    </li>
                    <li>
                        <div class="title">Complaint auto-response:</div>
                        <div class="text"><input type="checkbox" name="disable_autoresponder" value="1" <?php echo $info['disable_autoresponder']?'checked="checked"':''; ?> >
                    <strong>Disable</strong> auto-response. <em>(Overwrites Dept. settings)</em>
                    </div>
                    </li>
                    <li>
                        <div class="title">Canned Response:</div>
                        <div class="text">
...
<div class="block-fluid ucard">
            <div class="info">                                                                
                <ul class="rows">
                   <!--header start-->
                    <li class="heading"><div class="isw-users"><?php echo $title; ?></div><em>Filters are executed based on execution order. Filter can target specific Complaint source.
            </em></li>
                   <!-- header end-->
                    <li>
                ...
                &nbsp;<span class="error">*&nbsp;<?php echo $errors['name']; ?></span>
                    ...
                    <li>
                        <div class="title">Execution Order:</div>
                        <div class="text"><input type="text" size="6" name="execorder" value="<?php echo $info['execorder']; ?>">
                <em>(1...99 )</em>
                ...
                <strong>Stop</strong> processing further on match!
                    ...
                    <li>
                        <div class="title">Filter Status:</div>
                        <div class="text">
                ...
                &nbsp;<span class="error">*&nbsp;</span>
                    ...
                    <li>
                        ...
                        <div class="text"><select name="target">
...
<div class="block-fluid ucard">
            <div class="info">                                                                
                <ul class="rows">
                   <!--header start-->
                    <li class="heading"><div class="isw-users"></div><em><strong>Filter Rules</strong>: Rules are applied based on the criteria.&nbsp;<span class="error">*&nbsp;<?php echo $errors['rules']; ?></span></em></li>
                   <!-- header end-->
                    <li>
                        <div class="title"><em>Rules Matching Criteria:</em></div>
                        <div class="text">
                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                <label class="checkbox inline"><input type="radio" name="match_all_rules" value="1" <?php echo $info['match_all_rules']?'checked="checked"':''; ?>></label>Match All
                &nbsp;&nbsp;&nbsp;
                <label class="checkbox inline"><input type="radio" name="match_all_rules" value="0" <?php echo !$info['match_all_rules']?'checked="checked"':''; ?>></label>Match Any
                &nbsp;<span class="error">*&nbsp;</span>
        ...
        for($i=1; $i<=$n; $i++){ ?>
             ...
             <input type="text" size="30" name="rule_v<?php echo $i; ?>" value="<?php echo $info["rule_v$i"]; ?>">
                ...
                <a href="#" class="clearrule">(clear)</a></div>
                <?php
                } ?>    
                    </li>
...
<div class="block-fluid ucard">
            <div class="info">                                                                
                <ul class="rows">
                   <!--header start-->
                    <li class="heading"><div class="isw-users"></div><strong>Admin Notes</strong>:<em>&nbsp;&nbsp;&nbsp;(Internal notes)</em></li>
                   <!-- header end-->
                    <li><div class="title">Admin Notes</div>
