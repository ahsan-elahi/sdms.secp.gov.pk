...
<div class="page-header"><h1>Complaints <small>And Details</small></h1></div>  
<div class="row-fluid">
...
$alret='style="background-color: #fee7e7 !important;"';
       ...
       <td <?php echo $alret; ?> title="<?php echo $row['email']; ?>" nowrap>
              ...
              <a class="Icon <?php echo strtolower($row['source']); ?>Ticket ticketPreview" title="Preview Complaint " 
                ...
                href="tickets.php?action=subdeptview&subdeptviewid=<?php echo $row['ticket_id']; ?>"><?php echo $tid; ?></a>
<?php  
	if($thisstaff->isAdmin() || $thisstaff->getGroupId()=='7' )
