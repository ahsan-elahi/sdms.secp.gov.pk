...
switch(strtolower($_REQUEST['status'])){ //Status is overloaded
	...
	case 'referred_to_third_party':
	$status='referred_to_third_party';
	$inner_status='19,20,21,22';
	break;
...
$qwhere .=" )  AND ticket.status = 'closed' ";   	
	...
	//$qwhere.=" AND (ticket.complaint_status = '9' OR ticket.complaint_status = '10' OR ticket.complaint_status = '11' OR ticket.complaint_status = '12' OR ticket.complaint_status = '13')  AND ticket.status = 'closed' ";   	
	}elseif($status == 'sub_judice'){
	$table_heading = 'Sub Judice';
	
	$qwhere .=" AND ( ";
$sql_sub_status="SELECT * FROM `sdms_status` WHERE p_id='3'";
$res_sub_status=mysql_query($sql_sub_status);
$num_sub_status = mysql_num_rows($res_sub_status);
while($row_sub_status=mysql_fetch_array($res_sub_status)){
$qwhere .=" ticket.complaint_status = '".$row_sub_status['status_id']."' OR";
...
$qwhere .=" )  AND ticket.status = 'open' ";   
	...
	//$qwhere.=" AND (ticket.complaint_status = '14' OR ticket.complaint_status = '18')  AND ticket.status = 'open'";   	
	}elseif($status == 'referred_to_third_party'){
	$table_heading = 'Referred To Third Party';
	
		$qwhere .=" AND ( ";
$sql_sub_status="SELECT * FROM `sdms_status` WHERE p_id='4'";
$res_sub_status=mysql_query($sql_sub_status);
$num_sub_status = mysql_num_rows($res_sub_status);
while($row_sub_status=mysql_fetch_array($res_sub_status)){
$qwhere .=" ticket.complaint_status = '".$row_sub_status['status_id']."' OR";
...
$qwhere .=" )  AND ticket.status = 'open' "; 
	...
	//$qwhere.=" AND (ticket.complaint_status = '19' OR ticket.complaint_status = '20' OR ticket.complaint_status = '21' OR ticket.complaint_status = '22')  AND ticket.status = 'open'";   	
	}
	elseif($status == 'resolved'){
	$table_heading = 'Resolved';
	
		$qwhere .=" AND ( ";
$sql_sub_status="SELECT * FROM `sdms_status` WHERE p_id='5'";
$res_sub_status=mysql_query($sql_sub_status);
$num_sub_status = mysql_num_rows($res_sub_status);
while($row_sub_status=mysql_fetch_array($res_sub_status)){
$qwhere .=" ticket.complaint_status = '".$row_sub_status['status_id']."' OR";
...
$qwhere .=" )  AND ticket.status = 'closed' "; 
	...
	//$qwhere.=" AND ticket.complaint_status = '23'  AND ticket.status = 'closed'";   	
}else{
...
$pageNav->setURL('primary_status.php',$qstr.'&sort='.urlencode($_REQUEST['sort']).'&order='.urlencode($_REQUEST['order']));
...
<form action="primary_status.php" method="get">
...
<?php /*?><div class="span3" style="float:right">
    ...
    <form action="primary_status.php" method="POST" name='tickets' id="status-form">
    ...
    <div class="row-fluid">
        ...
        <div class="span12">                    
            ...
            <div class="head clearfix">
                ...
                <div class="isw-grid"></div><h1><?php echo $table_heading .' Complaints'; ?></h1>                               
