...
<?php
$company_types = array('Commodities Broker','Debt Security Trustee','Securities Broker','Share Registrar');
  ...
  <div class="span12">
    ...
    <div class="block-fluid table-sorting clearfix">
        <table cellpadding="0" cellspacing="0" width="100%" class="table">
          ...
          <tbody class="" page="1">
			<?php 		
		    $sql_status="SELECT cm_broker_title as compay,count(cm_broker_title) as total ,group_concat( complaint_id ) as complaint_ids, group_concat( cm_broker_title) AS companies FROM `sdms_ticket_capital_markets` WHERE ".$broker_title." AND cm_type = '".$company_type."'   group by `cm_broker_title`  order by total desc limit 10 ";			
...
<?php
$agent_types = array('Securities Broker');
foreach($agent_types as $agent_type){?>
<div class="row-fluid">
  <div class="span12">
    <div class="head clearfix">
      <div class="isw-grid"></div>
      <h1>Most Complaints Against Agent</h1>
    </div>
    <div class="block-fluid table-sorting clearfix">
        <table cellpadding="0" cellspacing="0" width="100%" class="table">
          <thead>
...
$href_company = 'report_tickets.php?action=cm_agent&agent_type='.urlencode($agent_type).'&agent='.urlencode($row_status['agent']).'';
$href_company_1to15days = $href_company.'&r_type=1to15days&from_date='.$today_date.'&to_date='.$days_1to15.'';
$href_company_16to30days = $href_company.'&r_type=16to30days&from_date='.$days_1to15.'&to_date='.$days_15plus.'';
$href_company_31to45days = $href_company.'&r_type=31to45days&from_date='.$days_15plus.'&to_date='.$days_30plus.'';
$href_company_45daysplus = $href_company.'&r_type=45daysplus&from_date='.$days_30plus.'';

$href_type = 'report_tickets.php?action=cm_agent_subtotal&agent_type='.urlencode($agent_type).'';
$href_type_1to15days =$href_type.'&r_type=1to15days&from_date='.$today_date.'&to_date='.$days_1to15.'';
$href_type_16to30days =$href_type.'&r_type=16to30days&from_date='.$days_1to15.'&to_date='.$days_15plus.'';
$href_type_31to45days =$href_type.'&r_type=31to45days&from_date='.$days_15plus.'&to_date='.$days_30plus.'';
$href_type_45daysplus =$href_type.'&r_type=45daysplus&from_date='.$days_30plus.'';
...
<?php /*?><div class="row-fluid">
  <div class="span12">
    <div class="head clearfix">
      <div class="isw-grid"></div>
      <h1>Capital Market Most Complaints Against Agent</h1>
    </div>
    <div class="block-fluid table-sorting clearfix">
        <table cellpadding="0" cellspacing="0" width="100%" class="table">
          <thead>
...
<?php if($num_total>0){ ?>
            <tr>
              ...
              <a href="tickets.php?agent=<?php echo $row_status['agent'];?>&action=cm_agent">
			  <?php echo $num_total; $subnum_status_comp +=$num_total; ?>
              </a>
              </span></b></td>
...
<div class="row-fluid">
  <div class="span12">
    <div class="head clearfix">
      <div class="isw-grid"></div>
      <h1>Capital Market Most Complaints By Complainant</h1>
    </div>
    <div class="block-fluid table-sorting clearfix">
        <table cellpadding="0" cellspacing="0" width="100%" class="table">
          <thead>
...
$href_company = 'report_tickets.php?action=cm_complainant&email='.urlencode($row_status['email']).'';
$href_company_1to15days = $href_company.'&r_type=1to15days&from_date='.$today_date.'&to_date='.$days_1to15.'';
$href_company_16to30days = $href_company.'&r_type=16to30days&from_date='.$days_1to15.'&to_date='.$days_15plus.'';
$href_company_31to45days = $href_company.'&r_type=31to45days&from_date='.$days_15plus.'&to_date='.$days_30plus.'';
$href_company_45daysplus = $href_company.'&r_type=45daysplus&from_date='.$days_30plus.'';

$href_type = 'report_tickets.php?action=cm_complainant_subtotal';
$href_type_1to15days =$href_type.'&r_type=1to15days&from_date='.$today_date.'&to_date='.$days_1to15.'';
$href_type_16to30days =$href_type.'&r_type=16to30days&from_date='.$days_1to15.'&to_date='.$days_15plus.'';
$href_type_31to45days =$href_type.'&r_type=31to45days&from_date='.$days_15plus.'&to_date='.$days_30plus.'';
$href_type_45daysplus =$href_type.'&r_type=45daysplus&from_date='.$days_30plus.'';
...
?>
            <tr>
              ...
              <td><b><span align="right">
			  <a href="tickets.php?name=<?php echo $row_total['name'];?>&action=cm_complainant">
			  <?php echo $num_total; $subnum_status_comp += $num_total; ?>
              </a>
              </span></b></td>
              <td><?php echo $t_1to15days;  $subt_1to15days += $t_1to15days;  ?></td>
...
<div class="dr"><span></span></div><?php */?>
</div>
<!--WorkPlace End-->
</div>
