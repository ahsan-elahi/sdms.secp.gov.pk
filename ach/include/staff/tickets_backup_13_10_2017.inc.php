...
<div class="row-fluid">
  ...
  <div class="span2" style="float:right;">
      <p align="right" style="float:right;"> <a href="complaints_lisitng.csv"><button class="btn" type="button" ><i class="icon-print"></i> Export</button></a>
      </p>
  </div>
...
<div class="span6" style="float:right;">
    <p align="right" style="float:right;"><span class="box_new assigned_new">&nbsp;&nbsp;&nbsp;&nbsp;</span>&nbsp;Assigned Complaint</p>        
    <p align="right" style="float:right;"><span class="box_new handled_new">&nbsp;&nbsp;&nbsp;&nbsp;</span>&nbsp;Handled Complaint</p>
    <p align="right" style="float:right;"><span class="box_new pending_new">&nbsp;&nbsp;&nbsp;&nbsp;</span>&nbsp;Pending Complaint</p>
  </div>
  </div>
...
?>
		 ...
		 $sql_fetchstatus = "Select * from sdms_status where status_id='".$row['complaint_status']."'";
		  ...
		  echo $row_fetchpstatus['status_title'];
