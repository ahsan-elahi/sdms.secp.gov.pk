			...
			<div class="info">                                                                
				<ul class="rows">
					...
					<li>
						...
						<div class="text"><?php 
						if($row_securities_markets['company_title']!='')
						 echo $row_securities_markets['company_title'];
						 else
						 echo 'Null';
						  ?></div>
					</li>
					<li>
						...
						<div class="text"><?php 
						if($row_securities_markets['share_registrar']!='')
						echo $row_securities_markets['share_registrar'];
						else
						echo 'Null';
						 ?></div>
					</li>
					<li>
						...
						<div class="text"><?php 
						if($row_securities_markets['underwriter']!='')
						echo $row_securities_markets['underwriter'];
						else
						echo 'Null' ?></div>
					</li>
					<li>
						...
						echo $row_securities_markets['debt_security_trustee']; ?></div>
					</li>
					<li>
...
<form action="tickets.php?id=<?php echo $ticket->getId(); ?>#deny"  method="post">
<?php csrf_token(); ?>
<input type="hidden" name="id" value="<?php echo $ticket->getId(); ?>">
...
<ul>
<?php if($thisstaff->canAssignTickets()) { ?><li><a id="assign_tab" href="#assign"><?php echo $ticket->isAssigned()?'Reassign Complaint':'Assign Complaint'; ?></a></li><?php  } ?>
...
<li><a id="reply_tab" href="#reply">Customer Reply</a></li>
<?php } ?>
</ul>
<!--Assign Complaint-->                     
...
<div class="span9">
<select name="" style="width:300px;" onChange="get_Sub_Status(this.value)">
...
<div class="span9">
<select onChange="get_subcategory(this.value);" id="select_1">
...
<div class="footer tar" style="margin-top: 0px;">
<input type="submit" class="btn" value="Select Category" />
<input type="reset" class="btn" value="Reset" />
</div>                            
</div>
       </form>
...
<div class="span3">Complaint Status:</div>
<div class="span9">
<select name="" style="width:300px;" onChange="get_Sub_Status_note(this.value)">
<option value="">--Select Status--</option>
<?php
$sql_get_child_status='SELECT *  FROM sdms_status status WHERE status_id = '.$ticket->complaint_status_title().' ';
$res_get_child_status=db_query($sql_get_child_status);
...
<div class="span3">Complaint Status:</div>
<div class="span9">
<select name="" style="width:300px;" onChange="get_Sub_Status_reply(this.value)">
<option value="">--Select Status--</option>
<?php
$sql_get_child_status='SELECT *  FROM sdms_status status WHERE status_id = '.$ticket->complaint_status_title().' ';
$res_get_child_status=db_query($sql_get_child_status);
