...
myWindow=window.open("comlainttopics_print.php","Print Report","toolbar=yes,width=800px,height=14031px");
myWindow.print() ;
//myWindow.close();
}
</script>
    ...
    <div class="row-fluid">
        <div class="span12">                    
            <div class="head clearfix">
                ...
                <h1><?php echo 'Complaints Topics Count'; ?></h1>                               
            </div>
        ...
        if($result && ($num=db_num_rows($result))):
            ...
            <tr>
                ...
                <span style="color:#666; float: left; width:350px;"><?php if($row['topic']!="") echo $row['topic']; else echo "No Category";?></span></a></th>
               &nbsp;&nbsp;
            ...
            $row4 = db_fetch_array($result4);*/?>
                <!--<td><?php //echo '<b><span align="right">'.$row4['close'].'</span></b><br />'; ?>
                </td>-->   
