...
function category_tree($catid){
	...
	$sql_topics = "SELECT * FROM `sdms_help_topic` WHERE dept_id = '".$_POST['dept_id']."' AND topic_pid = '".$catid."' AND isnature = '1' ";
...
function count_complaint($topic_id,$department,$one_time){
	...
	global $from_to_date;
	if($one_time == 1){
	$sql_tickets = "SELECT * FROM `sdms_ticket` WHERE isquery = '1' AND topic_id='".$topic_id."' AND dept_id='".$department."' ".$from_to_date."";
	...
	$sql_inner_topics = "SELECT * FROM `sdms_help_topic` WHERE dept_id = '".$department."' AND topic_pid = '".$topic_id."' AND isnature = '1' ";
	...
	while($row_inner_topics = mysql_fetch_array($res_inner_topics)){
		...
		$sql_inner_tickets = "SELECT * FROM `sdms_ticket` WHERE isquery = '1' AND topic_id='".$row_inner_topics['topic_id']."' AND dept_id='".$department."' ".$from_to_date."";
...
function get_open_complaints_by_topic_id($topic_id){
	...
	$sql_topic_comp = "SELECT * FROM `sdms_ticket` WHERE isquery = '1' AND status = 'open' AND topic_id='".$topic_id."' ".$dept_add." ".$from_to_date."";
$res_topic_comp = mysql_query($sql_topic_comp);
$num_topic_comp = mysql_num_rows($res_topic_comp);
...
function get_closed_complaints_by_topic_id($topic_id){
	...
	$sql_topic_comp = "SELECT * FROM `sdms_ticket` WHERE isquery = '1' AND status = 'closed' AND topic_id='".$topic_id."' ".$dept_add." ".$from_to_date."";
$res_topic_comp = mysql_query($sql_topic_comp);
$num_topic_comp = mysql_num_rows($res_topic_comp);
...
function get_open_complaints_by_deparment(){
	global $dept_add;
	global $from_to_date;
	$sql_topic_deprt = "SELECT * FROM `sdms_ticket` WHERE isquery = '1' AND status = 'open' ".$dept_add."  ".$from_to_date."";
$res_topic_deprt = mysql_query($sql_topic_deprt);
$num_topic_deprt = mysql_num_rows($res_topic_deprt);
return $num_topic_deprt;
}
function get_closed_complaints_by_deparment(){
	global $dept_add;
	global $from_to_date;
	$sql_topic_deprt = "SELECT * FROM `sdms_ticket` WHERE isquery = '1' AND status = 'closed'  ".$dept_add."  ".$from_to_date."";
$res_topic_deprt = mysql_query($sql_topic_deprt);
$num_topic_deprt = mysql_num_rows($res_topic_deprt);
return $num_topic_deprt;
}
