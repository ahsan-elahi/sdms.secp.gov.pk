...
if($status=='lodged')
{
	...
	$qwhere.=" AND (ticket.complaint_status = '6' OR ticket.complaint_status = '7' OR ticket.complaint_status = '8')";   	
	}elseif($status == 'closed'){
	$table_heading = 'Closed';
	$qwhere.=" AND (ticket.complaint_status = '9' OR ticket.complaint_status = '10' OR ticket.complaint_status = '11' OR ticket.complaint_status = '12' OR ticket.complaint_status = '13') ";   	
	}elseif($status == 'sub_judice'){
	$table_heading = 'Sub Judice';
	$qwhere.=" AND (ticket.complaint_status = '14' OR ticket.complaint_status = '18') ";   	
	}elseif($status == 'referred_to_third_party'){
	$table_heading = 'Referred To Third Party';
	$qwhere.=" AND (ticket.complaint_status = '19' OR ticket.complaint_status = '20' OR ticket.complaint_status = '21' OR ticket.complaint_status = '22') ";   	
	}
	elseif($status == 'resolved'){
	$table_heading = 'Resolved';
	$qwhere.=" AND ticket.complaint_status = '23'";   	
}else{
...
<!--<?php //if($thisstaff->canManageTickets()) { ?> id="tSortable" <?php //}else{ ?> id="tSortable_7" <?php //}?> >-->
...
$alret='';
        ...
        <tr id="<?php echo $row['ticket_id']; ?>">
		  ...
		  echo $row_fetchstatus['status'];*/ echo $row['status']; ?><?php //echo $row['staff']; ?></td>         
