...
<div class="page-header">   
  <h1>Most Complaints Against by <small> Broker</small></h1>
</div>
<!--<div class="row-fluid">
...
<div class="row-fluid">
  <div class="span12">
    <div class="head clearfix">
      ...
      <h1>Capital Market Most Complaints Against by Broker</h1>
    </div>
    <div class="block-fluid table-sorting clearfix">
        <table cellpadding="0" cellspacing="0" width="100%" class="table">
          ...
          <tbody class="" page="1">
            <?php 		
$sql_status="SELECT cm_broker_title as compay,count(cm_broker_title) as total ,group_concat( complaint_id ) as complaint_ids, group_concat( cm_broker_title ) AS companies FROM `sdms_ticket_capital_markets` WHERE cm_broker_title!='' AND cm_type != 'Share Registrar'  group by `cm_broker_title` order by total desc limit 10";
...
<div class="row-fluid">
  <div class="span12">
    <div class="head clearfix">
      <div class="isw-grid"></div>
      <h1>Insurance Most Complaints Against by Broker</h1>
    </div>
    <div class="block-fluid table-sorting clearfix">
        <table cellpadding="0" cellspacing="0" width="100%" class="table">
          <thead>
          ...
          <tbody class="" page="1">
            <?php 		
$sql_status="SELECT i_broker_title as compay,count(i_broker_title) as total ,group_concat( complaint_id ) as complaint_ids, group_concat( i_broker_title ) AS companies FROM `sdms_ticket_insurance` WHERE i_broker_title!=''  group by `i_broker_title` order by total desc limit 10";
$res_status=mysql_query($sql_status);
$num_status = mysql_num_rows($res_status);
if($num_status>0){
