...
<div class="row-fluid">
  ...
  <tr>
    ...
    <th width="73">In Process</th>
    <th width="73">Closed</th>
    <th width="73">Sub Judice</th>
    <th width="73">Referred to third party</th>
    <th width="73">Resolved</th>
...
function category_tree($catid){
	...
	while($row = mysql_fetch_array($res_topics)){
		...
		echo '<li>' .$row['topic'];
				...
				echo '<div style="text-align: center;margin-right: 190px;float: right;">(';
				...
				echo '<div style="text-align: center;margin-right: -100px;float: right;">(';
				echo get_open_complaints_by_topic_id($row['topic_id']);
				echo ')</div>';

				echo '<div style="text-align: center;margin-right: -180px;float: right;">(';
				echo get_closed_complaints_by_topic_id($row['topic_id']);	
				echo ')</div>';

				echo '<div style="text-align: center;margin-right: -260px;float: right;">(';
				echo get_sub_judice_complaints_by_topic_id($row['topic_id']);	
				echo ')</div>';

				echo '<div style="text-align: center;margin-right: -340px;float: right;">(';
				echo get_referred_to_third_party_complaints_by_topic_id($row['topic_id']);	
				echo ')</div>';

				echo '<div style="text-align: center;margin-right: -421px;float: right;">(';
				echo get_resolved_complaints_by_topic_id($row['topic_id']);	
				echo ')</div>';
...
return '<a href="tickets.php?a=search&deptId='.$dept_id.'&topicId='.$topic_id.$date_range.'">'.$num_topic_comp.'</a>';
}
function get_open_complaints_by_topic_id($topic_id){
	...
	$sql_topic_comp = "SELECT * FROM `sdms_ticket` WHERE isquery = '0' AND complaint_status IN (Select status_id from sdms_status where p_id = '1') AND topic_id='".$topic_id."' ".$dept_add." ".$from_to_date."";
$res_topic_comp = mysql_query($sql_topic_comp);
$num_topic_comp = mysql_num_rows($res_topic_comp);
...
function get_closed_complaints_by_topic_id($topic_id){
	...
	$sql_topic_comp = "SELECT * FROM `sdms_ticket` WHERE isquery = '0' AND complaint_status IN (Select status_id from sdms_status where p_id = '2')  AND topic_id='".$topic_id."' ".$dept_add." ".$from_to_date."";
$res_topic_comp = mysql_query($sql_topic_comp);
$num_topic_comp = mysql_num_rows($res_topic_comp);
...
function get_sub_judice_complaints_by_topic_id($topic_id){
	global $dept_add;
	global $from_to_date;
	global $dept_id;
	global $date_range;

	$sql_topic_comp = "SELECT * FROM `sdms_ticket` WHERE isquery = '0' AND complaint_status IN (Select status_id from sdms_status where p_id = '3')  AND topic_id='".$topic_id."' ".$dept_add." ".$from_to_date."";
$res_topic_comp = mysql_query($sql_topic_comp);
$num_topic_comp = mysql_num_rows($res_topic_comp);
return '<a href="tickets.php?a=search&amp;deptId='.$dept_id.'&amp;topicId='.$topic_id.'&status=closed'.$date_range.'">'.$num_topic_comp.'</a>';
...
function get_referred_to_third_party_complaints_by_topic_id($topic_id){
	global $dept_add;
	global $from_to_date;
	global $dept_id;
	global $date_range;

	$sql_topic_comp = "SELECT * FROM `sdms_ticket` WHERE isquery = '0' AND complaint_status IN (Select status_id from sdms_status where p_id = '4')  AND topic_id='".$topic_id."' ".$dept_add." ".$from_to_date."";
$res_topic_comp = mysql_query($sql_topic_comp);
$num_topic_comp = mysql_num_rows($res_topic_comp);
return '<a href="tickets.php?a=search&amp;deptId='.$dept_id.'&amp;topicId='.$topic_id.'&status=closed'.$date_range.'">'.$num_topic_comp.'</a>';
...
function get_resolved_complaints_by_topic_id($topic_id){
	global $dept_add;
	global $from_to_date;
	global $dept_id;
	global $date_range;

	$sql_topic_comp = "SELECT * FROM `sdms_ticket` WHERE isquery = '0' AND complaint_status IN (Select status_id from sdms_status where p_id = '5')  AND topic_id='".$topic_id."' ".$dept_add." ".$from_to_date."";
$res_topic_comp = mysql_query($sql_topic_comp);
$num_topic_comp = mysql_num_rows($res_topic_comp);
return '<a href="tickets.php?a=search&amp;deptId='.$dept_id.'&amp;topicId='.$topic_id.'&status=closed'.$date_range.'">'.$num_topic_comp.'</a>';
...
return '<a href="tickets.php?a=search&deptId='.$dept_id.$date_range.'">'.$num_topic_deprt.'</a>';
}
function get_open_complaints_by_deparment(){
	global $dept_add;
	global $from_to_date;
	$sql_topic_deprt = "SELECT * FROM `sdms_ticket` WHERE isquery = '0' AND complaint_status IN (Select status_id from sdms_status where p_id = '1')  ".$dept_add."  ".$from_to_date."";
$res_topic_deprt = mysql_query($sql_topic_deprt);
$num_topic_deprt = mysql_num_rows($res_topic_deprt);
...
function get_closed_complaints_by_deparment(){
	global $dept_add;
	global $from_to_date;
	$sql_topic_deprt = "SELECT * FROM `sdms_ticket` WHERE isquery = '0' AND complaint_status IN (Select status_id from sdms_status where p_id = '2')  ".$dept_add."  ".$from_to_date."";
$res_topic_deprt = mysql_query($sql_topic_deprt);
$num_topic_deprt = mysql_num_rows($res_topic_deprt);
return $num_topic_deprt;
}
function get_sub_judice_complaints_by_deparment(){
	global $dept_add;
	global $from_to_date;
	$sql_topic_deprt = "SELECT * FROM `sdms_ticket` WHERE isquery = '0' AND complaint_status IN (Select status_id from sdms_status where p_id = '3')  ".$dept_add."  ".$from_to_date."";
$res_topic_deprt = mysql_query($sql_topic_deprt);
$num_topic_deprt = mysql_num_rows($res_topic_deprt);
return $num_topic_deprt;
}
function get_referred_to_third_party_complaints_by_deparment(){
	global $dept_add;
	global $from_to_date;
	$sql_topic_deprt = "SELECT * FROM `sdms_ticket` WHERE isquery = '0' AND complaint_status IN (Select status_id from sdms_status where p_id = '4')  ".$dept_add."  ".$from_to_date."";
$res_topic_deprt = mysql_query($sql_topic_deprt);
$num_topic_deprt = mysql_num_rows($res_topic_deprt);
return $num_topic_deprt;

}
function get_resolved_complaints_by_deparment(){
	global $dept_add;
	global $from_to_date;
	$sql_topic_deprt = "SELECT * FROM `sdms_ticket` WHERE isquery = '0' AND complaint_status IN (Select status_id from sdms_status where p_id = '5')  ".$dept_add."  ".$from_to_date."";
$res_topic_deprt = mysql_query($sql_topic_deprt);
$num_topic_deprt = mysql_num_rows($res_topic_deprt);
return $num_topic_deprt;
   ...
   <tr>
	...
	<td><?php echo get_sub_judice_complaints_by_topic_id(43);?></td>
	<td><?php echo get_referred_to_third_party_complaints_by_topic_id(43);?></td>
	<td><?php echo get_resolved_complaints_by_topic_id(43);?></td>
  ...
  <tr>
	...
	<td><?php echo get_sub_judice_complaints_by_deparment();?></td>
	<td><?php echo get_referred_to_third_party_complaints_by_deparment();?></td>
	<td><?php echo get_resolved_complaints_by_deparment();?></td>
