...
<div style="width:680px;">
    <h2>Complaint Variables</h2>
    Please note that non-base variables depends on the context of use. Visit Complaint Wiki for up to date documentation.
    <br/>
        ...
        <tr>
            <td width="55%" valign="top">
                <table width="100%" border="0" cellspacing=1 cellpadding=1>
                    <tr><td width="130">%{ticket.id}</td><td>Complaint ID (internal ID)</td></tr>
                    <tr><td>%{ticket.number}</td><td>Complaint number (external ID)</td></tr>
                    ...
                    <tr><td>%{ticket.client_link}</td><td>Client\'s Complaint view link</td></tr>
                    <tr><td>%{ticket.staff_link}</td><td>Staff\'s Complaint view link</td></tr>
            ...
            <td valign="top">
                <table width="100%" border="0" cellspacing=1 cellpadding=1>
                    ...
                    <tr><td>%{assigner}</td><td>Staff assigning the Complaint</td></tr>
