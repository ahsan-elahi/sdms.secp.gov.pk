...
Please do not respond to this sms';
		...
		/*CURLOPT_URL => 'https://connect.jazzcmt.com/sendsms_url.html?Username=03028504208&Password=123.123&From=8181&To='.$row_getcompalint['phone'].'&Message='.$smsmessage.'',*/
        CURLOPT_URL => 'http://smsctp1.eocean.us:24555/api?action=sendmessage&username=SECP&password=P@87654&recipient='.$row_getcompalint['phone'].'&originator=8181&messagedata='.$smsmessage.'',
