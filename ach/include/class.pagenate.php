...
class PageNate {
    ...
    function getPageLinks() {
        ...
        for ($i=$start_loop; $i <= $stop_loop; $i++) {
            $page = ($i - 1) * $this->limit;
            if ($i == $this_page) {
                $html .= "\n<a class=\"paginate_active\" tabindex=\"0\" href=\"$file&p=$i\" >$i</a>";
            } else {
                $html .= "\n<a class=\"paginate_button\" tabindex=\"0\" href=\"$file&p=$i\" >$i</a>";
            }
        }
        if($stop_loop<$total_pages){
            ...
            $html .= "\n<a id=\"tSortable_next\" class=\"next paginate_button\" tabindex=\"0\" href=\"$file&p=$nextspan\" >Next</a>";
        }        
        return $html;
    }
