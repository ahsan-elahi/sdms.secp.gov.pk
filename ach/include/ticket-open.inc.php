...
var settings = {
	url: "upload.php",
	method: "POST",
	allowedTypes:"jpg,jpeg,png,gif,doc,docx,pdf,zip,rar,inp",
	fileName: "myfile",
	multiple: false,
	onSuccess:function(files,data,xhr)
	{
		...
		$('#error').html('');
		$("#status").html("<font color='green'>Evidence 1 Upload is success</font>");
	...
	{		
		$("#status").html("<font color='red'>Evaluation Upload is Failed</font>");
	}
}
var settings1 = {
	url: "upload.php",
	...
	onSuccess:function(files,data,xhr)
	{
		...
		$('#error1').html('');
		$("#status1").html("<font color='green'>Technical Upload is success</font>");
		//var path= JSON.stringify(data);
		var path= JSON.parse(data);
		var path1=JSON.stringify(path).replace("\"",'');
		path1=path1.replace("\"",'');
	...
	onError: function(files,status,errMsg)
	{		
		$("#status1").html("<font color='red'>Technical Upload is Failed</font>");
	}
}
var settings2 = {
	url: "upload.php",
        ...
        <div class="info">
          <ul class="rows">
            ...
            <div id="identificaiton">
             ...
             <li>
                <div class="title">CNIC/NICOP/<br>Passport:</div>
...
<!--<li >
    ...
    ?>
         ...
         &nbsp;<font class="error"><b>*</b>&nbsp;<?php echo $errors['priorityId']; ?></font></div>
            ...
            <li id="show_against_detials">
              ...
              <div class="text">
                <select name="deptId" <?php  if($_REQUEST['action']=='') {?>onChange="get_popup(this.value);" <?php }?>  style="width:301px;" required>
  ...
  <div class="row-fluid">
    <div class="span6">
      ...
      <div class="block-fluid ucard">
        <div class="info">
          <ul class="rows">
            <li class="heading">Attach Evidence if any: Maximum 6 Files</li>
            <li>
  ...
  <div class="block"> 
    ...
    <p>
	 <input type="text" name="e_company_title" id="input_product" autocomplete="off" value=""  /></p>
