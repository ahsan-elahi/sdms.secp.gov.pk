...
$include_image = isset($_REQUEST['include_image']) ? TRUE : FALSE;
	...
	$message .= 'Your complaint has reached us and is currently under review. You should expect an update in this regard shortly.<br>';
	...
	$_REQUEST['notifi_title']='New Complaint Registered (SDMS SECP)';
...
$res_user_firebase = mysqli_query($conn, "SELECT * from sdms_app_users where 1");
